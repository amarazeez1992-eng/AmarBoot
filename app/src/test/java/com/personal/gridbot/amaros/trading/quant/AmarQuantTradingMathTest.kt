...
class AmarQuantTradingMathTest {
    ...
    @Test fun atrUsesWilderSmoothingInsteadOfSimpleRollingAverage() {
        assertEquals(2.25, AmarQuantTradingMath.atr(listOf(1.0, 2.0, 3.0), 2)!!, 1e-12)
        assertEquals(2.125, AmarQuantTradingMath.atr(listOf(1.0, 2.0, 3.0, 2.0), 2)!!, 1e-12)
    ...
    @Test fun volatilityDrawdownAndVarUseExplicitStatisticalDefinitions() {
        ...
        assertEquals(0.25, AmarQuantTradingMath.maxDrawdown(listOf(100.0, 80.0, 75.0))!!, 1e-12)
    ...
    @Test fun sizingAndKellyRejectUnsafeInputs() {
        assertEquals(100.0, AmarQuantTradingMath.riskPositionSize(10000.0, 0.01, 1.0, 1.0)!!, 1e-12)
        assertEquals(0.4, AmarQuantTradingMath.kellyFraction(0.6, 2.0)!!, 1e-12)
    ...
    @Test fun riskOfRuinUsesExplicitDrawdownBarrierAndModelAssumptions() {
        ...
        assertEquals(1.0, nonPositiveLogGrowth!!, 1e-12)
