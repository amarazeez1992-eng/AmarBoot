 ...
 *
 * Deterministically converts the already-established evidence dimensions into
 * one bounded quality score. It does not collect evidence, detect duplicates,
 * verify fingerprints, detect tampering, or perform claim verification.
 */
