...
object AmarNewsGateController {
    fun script(): String = """
        (function(){
          ...
          s.textContent=`
            /* Clear top placement: two independent controls, no center overlap. */
            #amarAiOrb{position:fixed!important;left:5vw!important;right:auto!important;top:11vh!important;bottom:auto!important;z-index:30!important;}
            #amarNewsGate{position:fixed!important;right:5vw!important;left:auto!important;top:11vh!important;bottom:auto!important;transform:translateZ(0)!important;animation:amarNewsFloat 3.6s ease-in-out infinite alternate,amarNewsGradient 7s ease-in-out infinite;box-shadow:0 0 18px rgba(49,231,255,.20),0 0 30px rgba(236,72,153,.14),inset 0 0 18px rgba(255,200,87,.10);}
            ...
            @media (max-width:520px){#amarAiOrb{left:4vw!important;top:10vh!important}#amarNewsGate{right:4vw!important;top:10vh!important}}
