...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        themeMode = runCatching {
            AmarThemeMode.valueOf(
                prefs.getString("theme_mode", AmarThemeMode.DARK.name) ?: AmarThemeMode.DARK.name
            )
        ...
        currentRoom?.let {
            roomHost.setContent {
                AmarTheme(palette(), themeMode) {
                    AmarRoomHostScreen(it, ::showHome, themeMode, ::onThemeModeChanged)
                }
            }
        }
    }
    ...
    private fun setVisualEffectsEnabled(enabled: Boolean) {
        ...
        home.evaluateJavascript(
            "window.setVisualEffectsEnabled && window.setVisualEffectsEnabled($enabled)",
            null
        )
    }
    ...
    private inner class HomeBridge {
        ...
        @JavascriptInterface fun setVisualEffectsEnabled(enabled: Boolean) {
