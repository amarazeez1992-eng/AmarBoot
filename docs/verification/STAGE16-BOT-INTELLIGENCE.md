...
**الحالة:** 🟢 Approved — Editable Reference  
**Items:** 120  
**الإضافات الداخلية:** غير مثبتة عدديًا حتى يتم العد الآلي  
**الكود:** ❌ لا يوجد  
**التنفيذ:** لم يبدأ  
**الإغلاق الدستوري:** تم اعتماد التصميم كمرجع قابل للتحرير

> **Note: This document is a design reference, not a frozen constitution.**  
> **It may be modified, extended, reduced, or restructured during Stage 16**  
> **implementation based on findings and owner decisions.**
...
# الجزء الثالث — الـ120 Item كاملة
...
1. GitHub Adapter
2. Forum Adapter
3. TradingView Adapter
4. Generic HTTP Adapter
5. robots.txt Respect
6. Session Manager
7. Content Type Detector
8. Encoding Handler
9. Parallel Fetch
10. Crawl Log
11. Retry with Backoff
12. Source Authorization Boundary Adapter

## 3. User Strategy Intake
...
5. Deduplicator
6. Relevance Ranker
7. Credibility Scorer
8. Cross-Validator
9. Synthesis Engine
10. Conflict Reporter
11. Citation Extractor
12. Source Reputation
13. Freshness Filter
14. Result Cache
15. Research Audit

## 14. Parameter Research Engine
...
## 17. Expert Opinion with Evidence
...
## 22. Interactive Refinement Loop
...
## 24. Conflict Resolution Between Concepts
...
## 32. Pine ↔ MQL5 ↔ Python Translator
...
1. Pine Extractor
2. MQL5 Skeleton Builder
3. Indicator Injector
4. Order Function Mapper
5. Risk Function Mapper
6. Parameter Injector
7. Compilation Check
8. Backtest Validator
9. Optimization Handler
...
14. Fidelity Check
15. Version Tracker
16. Deployment Handler
17. Broker Compatibility
18. MT5 Converter Audit

## 35. Multi-Broker Abstraction
...
7. Capability Matrix
8. Failover Logic
9. Latency Comparator
10. Cost Comparator
11. Broker Selector
12. Broker Audit

## 36. Cross-Stage Integration
...
## 37. Massive Source Access Layer
...
## 60. Deliberation Loop

**الوظيفة: ينتج Proposal فقط — القرار النهائي Stage 13.**
...
6. Vote Collector
7. Consensus Builder
8. Disagreement Tracker
9. Final Proposal
10. Deliberation Log
11. Deliberation Audit
12. Rollback
...
10. Version Tracker
11. Rollback Point
12. Learning Promotion Gate

## 70. Auto-parameter Adjustment
...
**الوظيفة: Order Router Interface فقط.**

1. Account Registry
2. Connection Manager
3. Balance Tracker
4. Order Router Interface
5. Failover
6. Isolation
7. Multi-Account Report
8. Multi-Account Audit
9. Version Tracker
10. Recovery Handler

## 105. Capital Protection
...
## 111. Bot Internal Deliberation Loop
...
## 119. Bot Performance Attribution
...
## 120. Bot Life & Lifecycle Governance
...
# الجزء الرابع — Boundary Corrections المعتمدة

1. **Item 42 — Execute Button + Input**  
   Internal Action = Native.  
   Financial Action = Stage 14.

2. **Item 59 — Internal Engines Layer**  
   Sub-Orchestrator / Consumer فقط.  
   Decision → Stage 13.  
   Execution → Stage 14.

3. **Item 62 — Standalone Mode**  
   Monitor + Alert + Safe Pause فقط.

4. **Item 67 — Kill Switch**  
   Bot Request → Stage 14 executes.

5. **Item 70 — Auto-parameter Adjustment**  
   Test → Shadow → Approval → Stage 14.

6. **Item 73 — Rollback**  
   Artifact Rollback = Native Stage 16.  
   Execution Rollback = Stage 14.

7. **Item 81 — Drawdown Protection**  
   Logic = Native Stage 16.  
   Enforcement = Stage 14.

8. **Item 104 — Multi-Account**  
   Order Router Interface فقط.  
   لا Execution Authority.

9. **Item 105 — Capital Protection**  
   Logic = Native Stage 16.  
   Enforcement = Stage 14.

10. **Item 107 — Live Adjustments**  
    Proposal Only.  
    لا Adjustment Executor.

11. **Item 108 — Bot Retirement**  
    Retirement Logic = Native Stage 16.  
    Positions Handoff → Stage 14.

---

# الجزء الخامس — Missing Additions المعتمدة

1. Source Authorization Boundary Adapter — Item 2
2. Analysis Sandbox Boundary — Item 6
3. User Intent Persistence Contract — Item 3
4. Generated-Code Provenance — Item 31
5. Authority Contract Validator — Item 36
6. Execution-UI Boundary Guard — Item 39
7. Validation Provenance Binding — Item 44
8. Stage Authority Router — Item 58
9. Engine Capability Contract — Item 59
10. Bounded-Mode Safety Contract — Item 62
11. Kill Request Contract — Item 67
12. Learning Promotion Gate — Item 69
13. Shadow-to-Live Promotion Contract — Item 70
14. Rollback Domain Classifier — Item 73
15. Protection Escalation Contract — Item 81
16. Sizing Authority Boundary — Item 84
17. Event-to-Execution Boundary — Item 91
18. Fill Event Ownership Contract — Item 98
19. Signal-to-Decision Handoff Contract — Item 100
20. Explainability Provenance Contract — Item 103
21. Capital Protection Enforcement Contract — Item 105
22. Adjustment Proposal Contract — Item 107
23. Retirement Execution Boundary — Item 108
24. Deliberation-to-Decision Boundary — Item 111

---

# الجزء السادس — Cleanup المعتمد

- Audit Audit → Removed
- Duplicate Fusion Audit → Removed
- Duplicate Memory Audit → Removed
- Anti-Block Strategy → Removed
- Merge Suggester → Kept as Suggestion Only
- Promotion/Reject Decider → Promotion Recommender
- Emergency Stop → Emergency Request
- Direct Position Closer → Removed
- Adjustment Executor → Removed
- Direct Deployment → Deployment Requester
- Direct Trading Pause → Trading Pause Requester

---

# الجزء السابع — قواعد الصلاحية والسلطة

1. Stage 16 لا يمتلك Decision Authority مستقلة.
2. Stage 16 لا يمتلك Execution Authority مستقلة.
3. Stage 16 لا يمتلك Evidence Authority موازية.
4. Stage 16 لا يمتلك Research Authority موازية.
5. Stage 16 لا يمتلك Signal Authority موازية لـStage 15.
6. Stage 13 هو صاحب القرار النهائي عندما يتعلق الأمر بالقرار.
7. Stage 14 هو صاحب سلطة التنفيذ المالي.
8. Stage 16 يستطيع بناء Proposal أو Request عندما يكون ذلك ضمن اختصاصه.
9. Proposal ≠ Decision.
10. Request ≠ Execution.
11. Signal ≠ Decision.
12. Execution لا يتم داخل Stage 16.

---

# الجزء الثامن — الحالة النهائية
...
- Missing Additions: **24**
- Cleanup: **تم تطبيقه**
- Agreements: **8**
- Code: ❌
- Execution: ❌

**الوثيقة مرجع تصميمي قابل للتحرير وليست Constitution مجمدة.**
